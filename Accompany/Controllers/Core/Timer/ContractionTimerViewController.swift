...
class ContractionTimerViewController: UIViewController {
  ...
  var timerAndRecordNavBarStackView : UIStackView = {
    ...
    var timerAndButtonStackView : UIStackView = {
      ...
      timerAndButtonStackView.backgroundColor = #colorLiteral(red: 0.9459111094, green: 0.9379461408, blue: 0.9782511592, alpha: 1)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = #colorLiteral(red: 0.9459111094, green: 0.9379461408, blue: 0.9782511592, alpha: 1)
