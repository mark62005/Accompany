  ...
  static func loadSampleTodoLists() -> [TodoList] {
    return [
      TodoList(trimester: .firstTrimester, todos: [
        ...
        Todo(title: "Nutrition Counseling & Patient Instructions (D3 Testing)", isCompleted: false, note: "Type notes"), Todo(title: "First Ultrasound", isCompleted: false, note: "Type notes"), Todo(title: "Prenatal examination and  Blood tests", isCompleted: false, note: "Type notes"), Todo(title: "Neisseria gonorrhoeae test & Chlamydia trachomatis test", isCompleted: false, note: "Type notes"),Todo(title: "Pap smear, Human papilloma virus", isCompleted: false, note: "Type notes"),Todo(title: "Cytomegalovirus screening", isCompleted: false, note: "Type notes"),Todo(title: "Diabetes test", isCompleted: false, note: "Type notes"),Todo(title: "NHI Regular blood screening for the first trimester", isCompleted: false, note: "Type notes"), Todo(title: "Spinal muscular atrophy", isCompleted: false, note: "Type notes"), Todo(title: "Thyroid function tests", isCompleted: false, note: "Type notes"), Todo(title: "Fragile X syndrome", isCompleted: false, note: "Type notes") ,Todo(title: "Toxoplasmosis screening", isCompleted: false, note: "Type notes"), Todo(title: "pregnant woman physical fitnessd", isCompleted: false, note: "Type notes"), Todo(title: "Non-invasive Prenatal test", isCompleted: false, note: "Type notes"), Todo(title: "Maternal blood Down’s syndrome screening for the first trimester", isCompleted: false, note: "Type notes"),Todo(title: "Preeclampsia risk assessment", isCompleted: false, note: "Type notes")
      ]),
